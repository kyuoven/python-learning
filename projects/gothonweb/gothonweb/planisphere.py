...
central_corridor = Room(
    "Central Corridor",
    """)
The Gothtons of Plant Percal #25 have invaded your ship and destroyed
your entire crew. You are the last surviving member and your last
mission is to get the neuron destruct bomb from the Weapons armory,
...
tell the one Gothon joke you know: Lbhe sbgure vf fb sng, jura fur fvgf
nebhaq gur ubhfr, fur fvgf nebhaq gur ubhr. The Gothon stops, tries not 
to laugh, then busts out laughing and can't move. While he's 
...
in it's container. There's a  keypad lock on the box and you need the
...
grab the neutron bombn and run as fast as you can to the bridge where you
must place it in the right spot.

You burst onto the bridge with the netron destruct bomb iunder your arm
and suprise 5 Gothons who are trying to take control of the ship. Each
...
escape_pod = Room(
    "Escape pod",
    """
You point your blaster at the bomv under your arm and the Gothons put
...
button and blast the lock so the Gothon's can't get out. Now that the
...
are on the ship. so your run is clear of interferences. You get to the
...
escapes out into the void of space, then implodes as the hull ruptures,
crushing you body into jam jelly.
""",
)
...
def load_room(name):
    ...
    Who gets to set a name?
    Can that expose a variaable?
    """
